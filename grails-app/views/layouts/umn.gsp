...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <!--END UofM TEMPLATE HEADER-->
        ...
        <div class="status">
          [Status]  <sec:ifLoggedIn>Logged in as <strong><sec:loggedInUserInfo field="username" /></strong> | <g:link controller='logout'>Logout</g:link></sec:ifLoggedIn><sec:ifNotLoggedIn>Not logged in | <g:link controller='login' action='auth'>Login</g:link></sec:ifNotLoggedIn>
        </div>
        <g:layoutBody />		
    ...
    <div class="grid_12" id="unit_footer2">
        <ul class="unit_footer_links">
            ...
            <li><a href="mailto:info@healthstudies.umn.edu">Contact Health Studies</a></li>
        </ul>
    </div>
    ...
    <div class="grid_7 alpha" id="footer_inner">
        <ul class="copyright"><li>&copy; 2009 Regents of the University of Minnesota. All rights reserved.</li>
